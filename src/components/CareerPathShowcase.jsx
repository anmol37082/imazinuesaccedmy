...
const courses = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Psychological Narrative & Story Pacing",
      "High-Impact Hook & Narrative Pacing",
    ],
    deadline: "Hurry up! last date to apply",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Search Authority & Organic Dominance",
      "Data-Backed Campaign Scaling",
    ],
    deadline: "Hurry up! last date to apply",
