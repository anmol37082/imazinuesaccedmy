        ...
        <div className={styles.grid}>
          ...
          <div className={`${styles.section} ${styles.contactSection}`}>
            ...
            <div className={styles.contactInfo}>
              <p className={styles.text}>
                <strong>Location:</strong> SCO 12, First Floor, Srishti Plaza,
                Old Kalka-Ambala Road, Opposite Delhi World Public School,
            ...
            >
              ...
              <span className={styles.whatsappText}>WhatsApp us</span>
            </a>
          </div>
        </div>
